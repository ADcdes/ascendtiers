...
function placeholderMode(label, envPrefix) {
  return {
    ...
    supportChannelId: process.env[`${envPrefix}_SUPPORT_CHANNEL_ID`] ?? '',
...
export const modes = {
  crystal: {
    ...
    supportChannelId: process.env.CRYSTAL_SUPPORT_CHANNEL_ID ?? '',
  ...
  sword: {
    ...
    supportChannelId: process.env.SWORD_SUPPORT_CHANNEL_ID ?? '',
  ...
  mace: {
    ...
    supportChannelId: process.env.MACE_SUPPORT_CHANNEL_ID ?? '',
